...
defmodule DevWeb.Router do
  ...
  scope "/", DevWeb do
    ...
    sign_in_route(
      path: "/sign-in",
      resources: [Example.Accounts.User, Example.Accounts.WebAuthnSimpersNoIdentityUser],
      overrides: [DevWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.DaisyUI],
      auth_routes_prefix: "/auth",
      webauthn_path: "/webauthn"
    )

    web_authn_route(Example.Accounts.WebAuthnSimpersNoIdentityUser, :web_authn,
      path: "/webauthn",
      auth_routes_prefix: "/auth",
    ...
    auth_routes(AuthController, Example.Accounts.WebAuthnSimpersNoIdentityUser)
  end
end
